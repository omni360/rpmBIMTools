...
namespace rpmBIMTools {
    ...
    public partial class familyNameEditor : System.Windows.Forms.Form
    {
        ...
        private void familyNameEditor_Load(object sender, EventArgs e)
        {
            ...
            string UniclassFile = File.ReadAllText(@"C:\rpmBIM\progs\uniclass2.json.txt");
            ...
            {
                familySelection.Rows.Add(family.UniqueId, family.Name, regex.IsMatch(family.Name) ? "true" : "false");
            }
        ...
        private void familyFormatSwitch_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (Symbols.Count() > 0)
            {
                ...
                familyManufacturer.Enabled = Manufacturer == null ? false : familyFormatSwitch.Checked;
                familyModel.Enabled = Model == null ? false : familyFormatSwitch.Checked;
                familyDescription.Enabled = Description == null ? false : familyFormatSwitch.Checked;
            }
            familyUniclass2.Enabled = familyFormatSwitch.Checked;
            familyCustom.Enabled = !familyFormatSwitch.Checked;
            if (familyFormatSwitch.Checked)
            {
        ...
        private void familySelection_SelectionChanged(object sender, EventArgs e)
        {
            ...
            familyRole.Text = categoryCheckElec.Contains(selectedFamily.FamilyCategory.Id.IntegerValue) ? "E" :
            ...
            {
                //TaskDialog.Show("test", regex.Match(selectedFamily.Name).Value.Split('-').GetValue(1) as string);
            ...
            if (Symbols.Count() == 0) {
                ...
                familyManufacturer.Enabled =  Manufacturer != null & familyFormatSwitch.Checked ? true : false;
                familyModel.Text = Model != null ? Model.AsString() : "< Not Used >";
                familyModel.Enabled = Model != null & familyFormatSwitch.Checked ? true : false;
                familyDescription.Text = Description != null ? Description.AsString() : "< Not Used >";
                familyDescription.Enabled = Description != null & familyFormatSwitch.Checked ? true : false;
            }
            ...
            using (Transaction t = new Transaction(doc, "Changing Family Name"))
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        familySelection.CurrentRow.Cells[2].Value = regex.IsMatch(selectedFamily.Name) ? "true" : "false";
